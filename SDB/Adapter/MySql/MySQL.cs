...
//		private SDB.Adapter.DBConfig.Settings.MySql  config;
//		public SDB.Adapter.DBConfig.Settings.MySql  Config
//		{
//			get
//			{
//				return config;
...
//		public int ExecuteNonQuery(ref MySqlTransaction transaction,string Sql)
//		{
//			int ret=0;
//			if ((transaction == null)) 
//				{
...
//		{
////*******************
//			MySqlCommand cmd = BuildCommand(spName, DataRowToHash(ds.Tables[TableIndex].Rows[0]));
...
//		/// <returns></returns>
//		public object FillTypedDS(MySqlDataAdapter da,object ds)
//		{
...
//		/// <returns></returns>
//		private object FillTypedDS(MySqlCommand cmd, object ds)
//		{
...
//		/// <returns></returns>
//		private DataSet Fill(MySqlCommand cmd)
//		{
//			cmd.CommandTimeout = 0;
//			MySqlDataAdapter da=new MySqlDataAdapter(cmd);
//			DataSet ds=new DataSet();
//			//MySqlTransaction trans=cmd.Transaction;
...
//		/// <param name="hsh"></param>
//		/// <returns></returns>
//		public MySqlCommand BuildCommand(string spName,NameValueCollection hsh)
//		{
...
//			string FieldVal;
//			string Prms = "";
//			MySqlCommand spFieldDef = new MySqlCommand("_spFieldDef", Connection);
//			spFieldDef.CommandType = CommandType.StoredProcedure;
//			//spFieldDef.Parameters.AddWithValue("@ProcName", cmd.CommandText);
//			spFieldDef.Parameters.Add("@ProcName", cmd.CommandText);
			
//			MySqlDataReader drProperties=null;
//			try 
//			{
...
//						//MySqlParameter prm=cmd.Parameters.AddWithValue (FieldName, FieldVal);
//						MySqlParameter prm = cmd.Parameters.Add(FieldName, FieldVal);
...
//							{
//								case "int":
//									prm.DbType = DbType.Int16; //SqlDbType.Int;
//									break;
//								case "bigint":
//									prm.DbType= DbType.Int32; //SqlDbType.BigInt;
//									break;
//								case "varchar":
//									prm.DbType = DbType.String; //SqlDbType.VarChar;
//									break;
//								default:
//									break;
//							}
...
//		{
//			MySqlCommand cmd=new MySqlCommand("_spLookupClass");
//			cmd.CommandType = CommandType.StoredProcedure;
...
//				if (sqlFileName.IndexOf(@"\") == -1 & sqlFileName.IndexOf("/") == -1)
//					sqlFileName = @"scripts\sql\SQL\" + sqlFileName;
